<template>
    <div class="jrvm-addr-picker">
        <popup v-model="show" @on-click-cancel="onClickCancel">
            <div class="jrvm-addr-picker-cont" v-if="show">
                <div class="jrvm-addr-picker-header">
                    <h3 class="jrvm-addr-picker-header-title" v-text="title"></h3>
                    <i class="jrvm-addr-picker-header-close" @click="onClickCancel" v-if="showClose"></i>
                    <div class="jrvm-addr-picker-header-addr">
                    ...
                    <div class="jrvm-addr-picker-header-line" :style="lineStyle"></div>
                </div>
                <div class="jrvm-addr-picker-select-list" :style="style">
                    <div class="jrvm-addr-picker-select-item" v-for="(item, index) in list" :key="index" :ref="`scroll_${index}`">
                        <ul>
        ...
        methods: {
            ...
            updateScroll (index) {
                if (this.scrollList[index]) {
                    ...
                    this.scrollList[index] = new BScroll(this.$refs[`scroll_${index}`][0], {mouseWheel: true, probeType: 3, click: true})
                }
            },
            // 输出结果
            setResult () {
